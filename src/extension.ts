                ...
                if (currentPanel) {
                    ...
                    currentPanel.webview.postMessage({
                        ...
                        config: {
                            ...
                            dragAndDropBranchActions: config.dragAndDropBranchActions,
                            dragAndDropCommitDefaultAction: config.dragAndDropCommitDefaultAction,
                            dragAndDropSourceActions: config.dragAndDropSourceActions,
