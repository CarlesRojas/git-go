...
export const BranchSelector: FC<BranchSelectorProps> = ({ onBranchesChange }) => {
  ...
  useEffect(() => {
    ...
    // The commit query itself carries the loaded pages across the resulting key change (see
    // useInfiniteGitCommits), so auto-selecting the new branch keeps the scroll where it is
